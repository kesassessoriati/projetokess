...
const GLOBAL_VARIABLES = [
  ...
  { token: "{{contact_id}}", label: "ID do contato" },
  { token: "{{lead_id}}", label: "ID do lead CRM" },
  { token: "{{status}}", label: "Status do ticket (pending/open/closed)" },
  { token: "{{queue}}", label: "Nome da fila do ticket" },
  { token: "{{contact_phone}}", label: "Telefone do contato" },
  { token: "{{contact_email}}", label: "E-mail do contato" },
  { token: "{{lead_status}}", label: "Status do lead" },
  { token: "{{lead_score}}", label: "Score do lead" },
  { token: "{{lead_temperature}}", label: "Temperatura do lead" },
  { token: "{{lead_source}}", label: "Origem do lead" },
  { token: "{{lead_campaign}}", label: "Campanha do lead" },
  { token: "{{responsavel}}", label: "Responsavel pelo lead/ticket" },
  { token: "{{funil_de_vendas}}", label: "Funil de vendas do lead" },
  { token: "{{estagio_funil}}", label: "Estagio do funil do lead" },
