...
const useStyles = makeStyles((theme) => ({
  ...
  quickNavBtn: (props) => ({
    ...
    "&.quickNavActive": {
      backgroundColor: props.primaryColor || (theme.palette.type === "dark" ? "#0f172a" : "#000000"),
...
const LoggedInLayout = ({ children }) => {
  ...
  const menuGroups = useMemo(
    () => [
      ...
      { title: "Automações", path: "/automations", icon: <FlashOnIcon />, menuKey: "automacoes", disabled: !planActive && location.pathname !== "/financeiro" },
      ...
      { title: "Chat Agendamento", path: "/lembretes", icon: <ScheduleIcon />, menuKey: "chat-agendamento", disabled: !planActive && location.pathname !== "/financeiro" },
