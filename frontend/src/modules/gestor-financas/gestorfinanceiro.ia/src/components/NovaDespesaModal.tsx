...
export const NovaDespesaModal = ({ isOpen, onClose }: NovaDespesaModalProps) => {
    ...
    const handleSave = async (e: React.FormEvent) => {
        ...
        const categoria = categoriasDespesa.find(c => c.nome === formData.categoria);
        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-[500px]">
                <DialogHeader>
                    ...
                    <DialogDescription>Registre um novo gasto.</DialogDescription>
                </DialogHeader>
